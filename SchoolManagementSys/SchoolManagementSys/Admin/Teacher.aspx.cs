    ...
    public partial class Teacher : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                if (ddlGender.SelectedValue != "0")
                {
                    ...
                    if (dt.Rows.Count == 0)
                    {
                        string query = "Insert into Teacher values (N'" + txtName.Text.Trim() + "', '" + txtDoB.Text.Trim() + "', '" + ddlGender.SelectedValue + "','" + txtMobile.Text.Trim() + "', '" + txtEmail.Text.Trim() + "', N'" + txtAddress.Text.Trim() + "', '" + txtPassword.Text.Trim() + "')";
                        fn.Query(query);
                    ...
                    {
                        lblMsg.Text = "Email <b>'" + email + "'</b> đã tồn tại!!! ";
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                fn.Query("Update Teacher set Name = N'" + name.Trim() + "', Mobile = '" + mobile.Trim() + "'," +
                    " Address = N'" + address.Trim() + "', Password = '" + password.Trim() + "' where TeacherId = '" + teacherId + "'");
