    ...
    public partial class Student : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                if (ddlGender.SelectedValue != "0")
                {
                    ...
                    //DataTable dt = fn.Fetch("Select * from Student where ClassId RollNo = '"+ ddlClass.SelectedValue + "'and RollNo'" + rollNo + "'");
                    DataTable dt = fn.Fetch("Select * from Student where ClassId  = '" + ddlClass.SelectedValue + "'and RollNo = '" + rollNo + "'");

                    if (dt.Rows.Count == 0)
                    {
                        string query = "Insert into Student values (N'" + txtName.Text.Trim() + "', '" + txtDoB.Text.Trim() + "', '" +
                          ddlGender.SelectedValue + "','" + txtMobile.Text.Trim() + "', '" + txtRoll.Text.Trim() + "', N'" + txtAddress.Text.Trim() + "', '" +
                    ...
                    {
                        lblMsg.Text = "Số báo danh <b>'" + rollNo + "'</b> đã tồn tại cho lớp đã chọn!!! ";
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                lblMsg.Text = "Học sinh đã xóa thành công!!!";
                lblMsg.CssClass = "alert alert-success";
                GridView1.EditIndex = -1;
                GetStudents();
            }
        ...
        protected void GridView1_RowUpdating (object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                fn.Query("Update Student set Name = N'" + name.Trim() + "', Mobile = '" + mobile.Trim() + "'," +
                    " Address = N'" + address.Trim() + "', RollNo = '" + rollNo.Trim() + "', ClassId = '" + classId + "' where StudentId = '" + studentId + "' ");
                lblMsg.Text = "Học sinh được cập nhật thành công!!!";
                lblMsg.CssClass = "alert alert-success";
                GridView1.EditIndex = -1;
                GetStudents();
            }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            { 
                ...
                ddlClass.DataValueField = "ClassId";
                ddlClass.DataBind();
                ddlClass.Items.Insert(0, "Chọn môn học");
