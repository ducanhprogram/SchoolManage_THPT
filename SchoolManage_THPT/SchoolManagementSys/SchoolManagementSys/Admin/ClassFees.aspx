       ...
       <%--margin-bottom--%>
         <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
             ...
             <div class="col-md-6">
                 ...
                 <asp:TextBox ID="txtFeeAmounts" runat="server" CssClass="form-control" placeholder="Nhập số học phí" TextMode="Number" required >
                ...
                <div class="table-container">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No record to display" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <ItemTemplate>
                                  <asp:Label ID="Label1" runat="server" Text='<%# String.Format("{0:N0} VNĐ", Eval("FeesAmount")) %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
